                        ...
                        while (continueLoop) {
                            ...
                            switch (choice) {
                                ...
                                case 2: {
                                    ...
                                    for (Event event : EventRepository.events) {
                                        if (event.getstatusOfEvent().equalsIgnoreCase("unbook")&&event.getEventOwner().getEmail().equals(loggedInUser.getEmail())) {
                                            System.out.println("Name Of Event :" + event.getNameOfEvent() + "\tID Of Event:" + event.getIdOfEvent());
                                ...
                                case 3: {
                                    {
                                        ...
                                        for (Event event : EventRepository.events) {
                                            if (event.getEventOwner().getEmail().equals(loggedInUser.getEmail()) && event.getEventStartTime().isAfter(currentDate)) {
                                                System.out.println("Name Of Event :" + event.getNameOfEvent() + "\tEvent Start Date:" + event.getEventStartTime() + "\n");
                                            }
                                        }

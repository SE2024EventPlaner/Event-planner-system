Feature: notifications
  ...
  Scenario: Admin Approval for Business Account Creation
    Given the admin is on the notification page in the admin account with email "hello2@gmail.com"
  ...
  Scenario: Announcement notification from admin to all users
    Given he admin is on the Announcement page in the admin account with email "hello2@gmail.com"
